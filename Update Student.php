...
print("<br>");
print("<br>");
$sql="UPDATE student1 SET S_ID='$_POST[S_ID]',T_ID='$_POST[T_ID]',S_NAME='$_POST[S_NAME]',S_CONTACT='$_POST[S_CONTACT]',School='$_POST[School]' WHERE S_NAME='$_POST[S_NAME]'";
if (!mysqli_query($connect,$sql))
  {	 
  die('Error: ' . mysqli_error($connect));
  }
echo '<script type = "text/javascript">window.alert("NOW YOU ARE A USER");</script>';
include 'Update Message.html';
